...
const pokemonList = [
  ...
  { id: 888, name: 'Zacian', types: ['fairy', 'steel'] },
  { id: 889, name: 'Zamazenta', types: ['fighting', 'steel'] },
  { id: 890, name: 'Eternatus', types: ['poison', 'dragon'] },
  { id: 891, name: 'Kubfu', types: ['fighting'] },
  { id: 892, name: 'Urshifu', types: ['fighting', 'dark'] }, // Single Strike; Rapid Strike is water, but we'll keep dark as it's the default
...
// Formas de Alola (IDs reales de PokeAPI)
  ...
  { id: 10100, name: 'Raichu (Alola)', types: ['electric', 'psychic'] },
  { id: 10101, name: 'Sandshrew (Alola)', types: ['ice', 'steel'] },
  { id: 10102, name: 'Sandslash (Alola)', types: ['ice', 'steel'] },
  { id: 10103, name: 'Vulpix (Alola)', types: ['ice'] },
  { id: 10104, name: 'Ninetales (Alola)', types: ['ice', 'fairy'] },
  { id: 10105, name: 'Diglett (Alola)', types: ['ground', 'steel'] },
  { id: 10106, name: 'Dugtrio (Alola)', types: ['ground', 'steel'] },
  { id: 10107, name: 'Meowth (Alola)', types: ['dark'] },
  { id: 10108, name: 'Persian (Alola)', types: ['dark'] },
  { id: 10109, name: 'Geodude (Alola)', types: ['rock', 'electric'] },
  { id: 10110, name: 'Graveler (Alola)', types: ['rock', 'electric'] },
  { id: 10111, name: 'Golem (Alola)', types: ['rock', 'electric'] },
  { id: 10112, name: 'Grimer (Alola)', types: ['poison', 'dark'] },
  { id: 10113, name: 'Muk (Alola)', types: ['poison', 'dark'] },
  { id: 10114, name: 'Exeggutor (Alola)', types: ['grass', 'dragon'] },
  { id: 10115, name: 'Marowak (Alola)', types: ['fire', 'ghost'] },
  ...
  { id: 10166, name: "Farfetch'd (Galar)", types: ['fighting'] },
  ...
  { id: 10179, name: 'Yamask (Galar)', types: ['ground', 'ghost'] },
  { id: 10180, name: 'Stunfisk (Galar)', types: ['ground', 'steel'] },
